...
import {
  ...
  vip3Image,
  vip4Image,
} from '@/common-pages/proxy/proxy.variable';
import LazyImage from '@/components/basic/image';
import i18n from '@i18n';
import {getCommissionRate} from '@/common-pages/proxy/proxy.service';
...
import CommissionError from '@/common-pages/proxy/components/commissionError';
const boxRadius = {
