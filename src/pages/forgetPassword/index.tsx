...
const ForgetPassword = () => {
  ...
  return (<PageContainer style={forgetPasswordStyles.container}
    pageNavProps={{
      text: '忘记密码',
      showBack: true,
    }}>
    <View>
      ...
      <Flex
        style={[forgetPasswordStyles.content, ...(showError ? [forgetPasswordStyles.error] : [])]}
        align="center">
        <TextInput
          placeholder="请输入手机号"
        ...
        {showError ? <Text style={forgetPasswordStyles.errorMessage}>{errorMessage}</Text> : <></>}
      </Flex>
      <Flex
        style={[forgetPasswordStyles.btn, ...(mobile && !showError ? [forgetPasswordStyles.btnActive] : [])]}
        isTouchView
        justify="center"
        align="center"
        onPress={() => {
