...
export default {
  ...
  proxy: {
    ...
    home: {
      ...
      'invitation-link': 'SHARE INVITATION LINK',
  ...
  'recharge-page': {
    ...
    tip: {
      ...
      tip1: 'If the transfer time is up, please fill out the deposit form again.',
      // tip2: 'Please do not use save UPI and save QR Code to recharge. Eachrecharge starts a new order.',
      tip2: 'The transfer amount must match the order you created, otherwise the money cannot be credited successfully.',
      tip3: 'If you transfer the wrong amount, our company will not be responsible for the lost amount!',
      tip4: 'Note: do not cancel the deposit order after the money has been transferred.',
