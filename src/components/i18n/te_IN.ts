export default {
  ...
  'recharge-page': {
    ...
    tip: {
      ...
      tip2: 'మార్పిడి మొత్తం మీరు సృష్టించిన ఆర్డర్‌తో సరిపోలాలి, లేనిచో డబ్బు జమ చేయబడదు.',
      tip3: 'తప్పుగా మొత్తాన్ని ట్రాన్స్‌ఫర్ చేస్తే, డబ్బు కోల్పోతే మేము బాధ్యత వహించము!',
      tip4: 'గమనిక: డబ్బు ట్రాన్స్‌ఫర్ చేసిన తర్వాత డిపాజిట్ ఆర్డర్‌ను రద్దు చేయవద్దు.',
