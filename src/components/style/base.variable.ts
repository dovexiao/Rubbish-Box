export const basicColor = {
  ...
  // 页面背景色配置
  newBgOne: ['#2E0001', '#230402'], //一级页面 68, 6, 2 35, 4, 2
  ...
  // 状态颜色
  newStatusRed: '#E92828', //进行中
  newStatusYellow: '#F7B500', //成功（完成）
  newStatusGrey: '#888888', //失败（未完成）
...
export const backgroundColor = {
  ...
  //中奖状态 背景渐变色
  wonLinearGradient: ['#F7B500', '#F7B50000'],
  //未中奖状态 背景渐变色
  noWinLinearGradient: ['#888888', '#88888800'],
  //未开奖状态 背景渐变色
  toDrawnLinearGradient: ['#E92828', '#E9282800'],
  blue: '#1776FF',
  blueGrey: '#B0AEA0',
  palegreyNext: '#F6F7FA',
