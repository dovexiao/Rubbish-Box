...
let IconANextpage: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconANextpage.defaultProps = {
  size: 18,
};

IconANextpage = React.memo ? React.memo(IconANextpage) : IconANextpage;

export default IconANextpage;
