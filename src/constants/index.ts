...
export const SEARCH_BLUETOOTH_STATUS_IMAGE = {
  [SEARCH_BLUETOOTH_STATUS.SEARCHING]: 'https://g.18qjz.cn/img/boklock/bluetooth_searched.gif',
  [SEARCH_BLUETOOTH_STATUS.SEARCH_SUCCESS]: 'https://g.18qjz.cn/img/boklock/bluetooth_success.png',
  [SEARCH_BLUETOOTH_STATUS.SEARCH_FAILED]: 'https://g.18qjz.cn/img/boklock/bluetooth_fail.png',
}
